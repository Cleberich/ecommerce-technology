...
const Checkout = () => {
  ...
  return (
    <div className="bg-white p-5 col-sm-12 col-md-7 mx-auto mt-3 text-start d-sm-block d-md-flex">
      <div className="col-sm-12 col-md-7 col-lg-7">
        <form className="" onSubmit={completarPedido}>
          <h2 className="fs-6 fw-bold mb-2 text-center">
            Detalle de facturación
          </h2>
          <label htmlFor="nombre" className="ms-1 fs-6">
            Nombre *
          </label>
          <input
            type="text"
            ...
            id="nombre"
          />
          <label htmlFor="apellido" className="ms-1 fs-6">
            Apellido{" "}
          </label>
          <input
            type="text"
            ...
            id="apellido"
          />
          <label htmlFor="direccion" className="ms-1 fs-6">
            Dirección{" "}
          </label>
          <input
            type="text"
            ...
            id="direccion"
          />
          <label htmlFor="departamento" className="ms-1 fs-6">
            Departamento
          </label>
          <input
            type="text"
            ...
            id="departamento"
          />
          <label htmlFor="email" className="ms-1 fs-6">
            Email *
          </label>
          <input
            type="email"
            ...
            id="email"
          />
          <label htmlFor="telefono" className="ms-1 fs-6">
            Telefono *
          </label>
          <input
            type="tel"
      ...
      <div className="col-sm-12 col-md-5 col-lg-5 d-block">
        <h2 className="text-center fs-6 fw-bold">Tu orden</h2>
        <h3 className="ms-5 me-4 mt-4 d-flex justify-content-between fs-6">
          Total a Pagar <span>${subtotal}</span>
        </h3>
        <div className="ms-4 d-flex justify-content-center">
          <input
            className=""
            type="checkbox"
            defaultChecked={QrMercadoPago}
            onChange={() => setQrMercadoPago(!QrMercadoPago)}
          />
          <label className="fs-7 ms-2">
            <QrCode2Icon /> <LogoMercadoPago />
          </label>
          <input
            className=""
            type="checkbox"
            defaultChecked={LinkMercadoPago}
            onChange={() => setLinkMercadoPago(!LinkMercadoPago)}
          />
          <label className="fs-7 ms-2">
            <InsertLinkIcon /> <LogoMercadoPago />{" "}
          </label>
        </div>
        <div className="mx-4">
          <button
            ...
            className="ms-4 mt-3 text-center btn btn-dark w-100"
          >
            Completar pedido
          </button>
        </div>
